...
function Socket(uri, opts){
  ...
  this.port = opts.port || (global.location && location.port ?
 	...
 	// stringify query
 	if ('object' == typeof this.query){
 		this.query = util.qs(this.query);
 	}
	...
	this.query += "EIO=" + encodeURIComponent(parser.protocol)
...
Socket.prototype.createTransport = function (name) {
  ...
  query += "transport="+ encodeURIComponent(name);

  if (this.id) {
    query += "&sid="+ encodeURIComponent(this.id);
  }
...
Socket.prototype.onHandshake = function (data) {
  ...
  this.id = data.sid;
	if (this.transport.query.length){
		this.transport.query+="&"
	}
  this.transport.query +="sid=" + encodeURIComponent(data.sid);
