...
exports.global = function () {
  return undef != typeof window ? window : global;
};
...
exports.defer = function (fn) {
  if (!exports.ua.webkit || undef != typeof importScripts) {
    return fn();
  }
...
exports.ua.hasCORS = undef != typeof XMLHttpRequest && (function () {
  try {
...
exports.ua.webkit = undef != typeof navigator &&
...
exports.ua.gecko = undef != typeof navigator &&
...
exports.ua.android = undef != typeof navigator &&
...
exports.ua.ios = undef != typeof navigator &&
...
exports.request = function request (xdomain) {
  ...
  if (xdomain && undef != typeof XDomainRequest && !exports.ua.hasCORS) {
    return new XDomainRequest();
  }

  // XMLHttpRequest can be disabled on IE
  try {
    if (undef != typeof XMLHttpRequest && (!xdomain || exports.ua.hasCORS)) {
