...
(function (global, factory) {
  ...
  var NegotiateError = /*#__PURE__*/function (_Error) {
    ...
    return _createClass(NegotiateError);
  }( /*#__PURE__*/_wrapNativeSuper(Error));
  function negotiate(_x, _x2) {
    return _negotiate.apply(this, arguments);
  }
  function _negotiate() {
    _negotiate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(opts, query) {
      var schema, uri, negotiateResult;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            schema = this.opts.secure ? "https" : "http";
            uri = createUri(_extends({}, this.opts, {
  ...
  var Socket = /*#__PURE__*/function (_Emitter) {
    ...
    _createClass(Socket, [{
      ...
      value: function () {
        var _negotiateAndOpen = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var negotiateResult, url;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return negotiate(this.opts, this.opts.query);
              case 3:
                negotiateResult = _context.sent;
